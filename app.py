...
@app.route('/dashboard')
def dashboard_page():
    # Sadece Pano/İstatistik ekranını yükler
    return render_template('dashboard.html')

@app.route('/map')
def map_page():
    # Sadece 81 İlli Bölgesel Harita ekranını yükler
...
def predict():
    try:
        ...
        # Verileri güvenli bir şekilde çek
        ...
        # Model varsa tahmin et, yoksa yedek algoritmayı çalıştır
        if model is not None:
            ...
            # Gelişmiş Yedek Klinik Puanlama Algoritmamiz
            score = 0
